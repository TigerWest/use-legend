...
export const SOURCE_PACKAGES = [
  ...
  { name: 'native', dir: 'native', demoSection: 'native', outputSection: 'native' as OutputSection },
  { name: 'integrations', dir: 'integrations', demoSection: 'integrations', outputSection: 'integrations' as OutputSection },
  { name: 'tanstack-query', dir: 'libraries/tanstack-query', demoSection: 'tanstack-query', outputSection: 'tanstack-query' as OutputSection },
] as const
