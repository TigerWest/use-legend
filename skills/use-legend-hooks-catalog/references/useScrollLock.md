...
<CodeTabs>
  ...
  <Fragment slot="scope">
    ```tsx
    import { createScrollLock } from "@usels/web";

    function Component() {
      "use scope"
      const { isLocked$, toggle } = createScrollLock();
...
export declare const useScrollLock: UseScrollLock;
```

## Source

- Implementation: `packages/web/src/sensors/useScrollLock/index.ts`
- Documentation: `packages/web/src/sensors/useScrollLock/index.mdx`