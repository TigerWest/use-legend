...
<CodeTabs>
  ...
  <Fragment slot="scope">
    ...
    import { createOnClickOutside } from "@usels/web";
...
export declare const useOnClickOutside: UseOnClickOutside;
```

## Source

- Implementation: `packages/web/src/sensors/useOnClickOutside/index.ts`
- Documentation: `packages/web/src/sensors/useOnClickOutside/index.mdx`