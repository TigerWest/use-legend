...
<CodeTabs>
  ...
  <Fragment slot="scope">
    ```tsx
    import { createOfflineFirst, observable } from "@usels/core";
    import { ObservablePersistLocalStorage } from "@usels/web";
...
export declare const useOfflineFirst: UseOfflineFirst;
```

## Source

- Implementation: `packages/core/src/sync/useOfflineFirst/index.ts`
- Documentation: `packages/core/src/sync/useOfflineFirst/index.mdx`