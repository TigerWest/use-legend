...
<CodeTabs>
  ...
  <Fragment slot="scope">
    ```tsx
    import { createComputedWithControl, observable } from "@usels/core";
...
export declare function useComputedWithControl<S, T>(source: Observable<S>, fn: (sourceValue: S, prev: T | undefined) => T): {
...
- Documentation: `packages/core/src/reactivity/useComputedWithControl/index.mdx`