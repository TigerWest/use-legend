...
export declare function useObserveWithFilter<T extends WatchSource>(selector: T, effect: Effector<T>, options: UseObserveWithFilterOptions): void;
```

## Source

- Implementation: `packages/core/src/observe/useObserveWithFilter/index.ts`
- Documentation: `packages/core/src/observe/useObserveWithFilter/index.md`