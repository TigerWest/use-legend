...
export declare function useEventListener<EventType = Event>(target: Observable<unknown> | ObservablePrimitive<unknown> | null | undefined, event: Arrayable<string>, listener: Arrayable<GeneralEventListener<EventType>>, options?: MaybeObservable<boolean | AddEventListenerOptions>): () => void;
export declare function useEventListener<EventType = Event>(target: MaybeElement | EventTarget | null | undefined, event: Arrayable<string>, listener: Arrayable<GeneralEventListener<EventType>>, options?: MaybeObservable<boolean | AddEventListenerOptions>): () => void;
