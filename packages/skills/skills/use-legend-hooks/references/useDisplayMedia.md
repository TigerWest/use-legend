...
export declare function useDisplayMedia(options?: DeepMaybeObservable<UseDisplayMediaOptions>): UseDisplayMediaReturn;
```

## Source

- Implementation: `packages/web/src/sensors/useDisplayMedia/index.ts`
- Documentation: `packages/web/src/sensors/useDisplayMedia/index.md`