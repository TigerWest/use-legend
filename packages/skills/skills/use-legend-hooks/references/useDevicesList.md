...
export declare function useDevicesList(options?: DeepMaybeObservable<UseDevicesListOptions>): UseDevicesListReturn;
```

## Source

- Implementation: `packages/web/src/sensors/useDevicesList/index.ts`
- Documentation: `packages/web/src/sensors/useDevicesList/index.md`