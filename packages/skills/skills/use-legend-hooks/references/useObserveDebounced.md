...
export declare function useObserveDebounced<T extends WatchSource>(selector: T, effect: Effector<T>, options?: UseObserveDebouncedOptions): void;
```

## Source

- Implementation: `packages/core/src/observe/useObserveDebounced/index.ts`
- Documentation: `packages/core/src/observe/useObserveDebounced/index.md`