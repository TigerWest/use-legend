...
export declare function useScope<P extends Record<string, unknown>, T extends object>(fn: (props: ReactiveProps<P>) => T, props: P): T;
```

## Source

- Implementation: `packages/core/src/state/useScope/index.ts`
- Documentation: `packages/core/src/state/useScope/index.md`